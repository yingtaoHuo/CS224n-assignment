...
def minibatch_parse(sentences, model, batch_size):
    ...
    for sentence in sentences:
        ...
        partial_parses.append(partial_parse)
    ...
    while(len(unfinished_parses) != 0):
        ...
        del_num = 0
        for i in range(min(batch_size, len(unfinished_parses))):
            if len(unfinished_parses[i - del_num].buffer)==0 and len(unfinished_parses[i - del_num].stack)==1:
                del unfinished_parses[i - del_num]
                del_num += 1
